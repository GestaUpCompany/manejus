-- Expõe total_mortes_geral e taxa_mortalidade_geral (histórico completo da
-- fazenda, sem filtro de data) para o relatório de mortalidade. A taxa de
-- mortalidade exibida na primeira página passa a ser a acumulada, estável
-- mesmo quando o usuário filtra um intervalo curto de datas.
