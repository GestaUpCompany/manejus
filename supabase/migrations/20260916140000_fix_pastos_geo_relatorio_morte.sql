-- Fix: ST_AsGeoJSON(p.geometria::geometry) falhava com "type geometry does not exist"
-- porque SET search_path TO 'public' esconde o tipo do PostGIS (schema extensions).
-- Remove o cast desnecessário e qualifica a função com o schema.
