-- RPC para sincronizar lote_pasto_historico e lote_modulo_historico
-- quando o pasto do lote é alterado pela edição administrativa no Painel Web.
-- O trigger trg_registros_pastagens_mover_lote só dispara via registros_pastagens;
-- a edição direta de lotes.pasto_id no Painel Web não passa por ele, deixando o
-- histórico aberto e o PWA bloqueando pastos fantasmas como "ocupados".
-- Esta RPC fecha o histórico antigo e abre o novo, espelhando a lógica do trigger.
