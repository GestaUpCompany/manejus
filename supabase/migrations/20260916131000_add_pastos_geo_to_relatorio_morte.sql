-- Adiciona pastos_geo (geometrias GeoJSON dos pastos da fazenda) ao retorno
-- do relatório de morte, para o PDF desenhar os polígonos no mapa.
...
BEGIN
  ...
  SELECT COALESCE(jsonb_agg(jsonb_build_object(
    'nome', p.nome,
    'geometry', ST_AsGeoJSON(p.geometria::geometry)::jsonb
