  ...
  return (
    <div className="space-y-4 sm:space-y-6 min-w-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h2 className="text-xl sm:text-2xl font-bold text-content-strong">Caderneta de Clima</h2>
      </div>
      ...
      <Card className="bg-surface-1 p-4 sm:p-6" disableHover>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
          ...
          <Button
            onClick={() => exportToXLSX(filteredRegistros, CLIMA_EXPORT_CONFIG, fazendaNome)}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="sm:col-span-2">
            ...
            <Input
              type="text"
              placeholder="Responsável, temperatura, observação..."
              value={searchTerm}
            ...
            {filteredRegistros.map((registro) => (
              ...
              >
                ...
                <div className="space-y-2 text-xs sm:text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-content-muted">Temperatura Média:</span>
                    <span className="text-content-strong font-medium">{registro.temperatura_media ? `${registro.temperatura_media}°C` : '-'}</span>
                  </div>
                  <div className="flex justify-between">
