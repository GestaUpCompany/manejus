...
const tabs: TabConfig[] = [
  ...
  },
  {
    ...
    table: 'itens_cantina',
    fields: [
      { name: 'nome', label: 'Nome', required: true, placeholder: 'Nome do alimento' },
      { name: 'classificacao', label: 'Classificação', required: true, placeholder: 'Selecione...', options: [
        { value: 'Perecíveis', label: 'Perecíveis' },
        { value: 'Não Perecíveis', label: 'Não Perecíveis' },
        { value: 'Bebidas', label: 'Bebidas' },
        { value: 'Limpeza/Higiene', label: 'Limpeza/Higiene' },
        { value: 'Hortifruti', label: 'Hortifruti' },
        { value: 'Carnes', label: 'Carnes' },
      ]},
      { name: 'unidade_medida', label: 'Unidade de Medida', required: true, placeholder: 'Selecione...', options: [
        { value: 'kg', label: 'kg' },
        { value: 'g', label: 'g' },
        { value: 'L', label: 'L' },
        { value: 'mL', label: 'mL' },
