  ...
  return (
    <div className="w-full min-w-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
        <h2 className="text-xl sm:text-2xl font-bold text-content-strong">Caderneta de Maternidade</h2>
      </div>

      <Card className="bg-surface-1 p-4 sm:p-6 mb-4" disableHover>
      ...
      {registros.length === 0 ? (
        <Card className="bg-surface-1 p-4 sm:p-6 text-center" disableHover>
          <p className="text-content-muted">Nenhum registro de maternidade encontrado</p>
        </Card>
        ...
        <>
            ...
            {filteredRegistros.map((registro) => (
              ...
              >
                ...
                <div className="space-y-2 text-xs sm:text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-content-muted">ID Brinco:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.id_brinco_mae || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">ID Chip:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.id_chip_mae || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">Categoria Mãe:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.categoria_mae || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">ID Provisório:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.id_provisorio_cria || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-content-strong font-medium">{registro.peso_cria_kg || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">Tipo Parto:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.tipo_parto || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">Lote:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.lote || '-'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-content-muted">Pasto:</span>
                    <span className="text-content-strong font-medium truncate max-w-[120px]">{registro.pasto || '-'}</span>
                  </div>
          ...
          {/* Desktop Table View */}
          <Card className="bg-surface-1 overflow-x-auto hidden sm:block max-w-full min-w-0" disableHover>
            <table className="min-w-full divide-y divide-border-base">
              <thead className="bg-surface-2">
                <tr>
                  ...
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">ID Brinco</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">ID Chip</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">Categoria Mãe</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">ID Provisório</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">Sexo</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">Peso (kg)</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">Tipo Parto</th>
                  ...
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-content-muted uppercase tracking-wider">Indivíduo</th>
                </tr>
              </thead>
